    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              "https://i.postimg.cc/63Gdvbr9/CTVQjm-FUAAADo-PY.jpg",
              ),
              Padding(
                ...
                child: Column(
                  children: [
                   const SizedBox(height: 10),
                    ...
                    const SizedBox(height: 10),
                  const Text(
                    'Selamat Menjalankan Ujian Tengah Semester',
                  ...
                  children: [
                   const SizedBox(height: 10),
                    Row(
                      ...
                      children: const [
                        Text(
                          'Semangat !! Selamat Menunaikan UTS',
                           style:
                            TextStyle(fontWeight: FontWeight.bold, fontSize: 20),
                        )
                      ],
                    ...
                    const SizedBox(height: 10),
                  const Text(
                    'UTS SEMESTER GENAP INSTITUT TEKNOLOGI GARUT',
                    maxLines: 10,
                    textAlign: TextAlign.justify,
                    overflow: TextOverflow.ellipsis,
                  )
